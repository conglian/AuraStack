...
class ASImg extends StatelessWidget {
  final String name;
  final double? width;
  final double? height;
  final double? size;
...
DecorationImage ASDImg(String name, {BoxFit fit = BoxFit.fill}) {
  var p = "$name".image();
...
class ASBouncyImage extends StatefulWidget {
  ...
  @override
  State<ASBouncyImage> createState() => _ASBouncyImageState();
}

class _ASBouncyImageState extends State<ASBouncyImage>
  ...
  @override
  void didUpdateWidget(covariant ASBouncyImage oldWidget) {
...
class ASAnimatedImageMove extends StatefulWidget {
  ...
  @override
  _ASAnimatedImageMoveState createState() => _ASAnimatedImageMoveState();
}

class _ASAnimatedImageMoveState extends State<ASAnimatedImageMove>
    with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant ASAnimatedImageMove oldWidget) {
    super.didUpdateWidget(oldWidget);
        ...
        return Transform.translate(
          ...
          child: Transform.scale(
            ...
            child: SizedBox(
              width: widget.ws,
              height: widget.hs,
              child: ASImg(name: widget.imageUrl),
            ),
          ),
        );
      },
