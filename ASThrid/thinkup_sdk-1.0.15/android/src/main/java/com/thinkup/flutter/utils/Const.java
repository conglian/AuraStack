...
public class Const {
    ...
    public static class Init {
        ...
        public static final String CUSTOM_DTUA_DIC = "customDataDic";
        ...
        public static final String PLACEMENT_CUSTOM_DTUA_DIC = "placementCustomDataDic";
        public static final String PLACEMENT_ID_STR = "placementIDStr";
        public static final String GDPR_UPLOAD_DTUA_LEVEL = "gdprLevel";
        public static final String APP_ID_STR = "appIdStr";
        public static final String APP_KEY_STR = "appKeyStr";
        public static final String PTUH_STR = "pathStr";
    ...
    public static String[] initMethodNames = {"setLogEnabled", "setChannelStr", "setSubchannelStr", "setCustomDataDic",
            ...
            "showGDPRAuth", "initSDK", "deniedUploadDeviceInfo", "setPresetPlacementConfigPath",
            "showGDPRConsentDialog", "showGDPRConsentSecondDialog", "checkIsEuTraffic", "showDebuggerUI",
            "setAdSourcePrivacyPolicy", "putFilter", "removeFilters", "removeFilterWithPlacementId",
            "getSDKVersionName", "setSharedPlacementConfig", "start"};
